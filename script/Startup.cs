	...
	void Update () {
		...
		case STEP.CHECK_CONFIG:
			if (bInit) {
				...
				#if UNITY_IPHONE
				NendAdInterstitial.Instance.Load("c4dd31b83bcccec9012b21a252577bbd036ab3ca", "562641");
				#elif UNITY_ANDROID
				NendAdInterstitial.Instance.Load ("5c3ff465384db34151deb56070cc71eb373a6532", "562646");
				#else
				#endif
